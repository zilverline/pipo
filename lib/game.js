...
var game = {
  ...
  round: function(wonByPlayer) {
    switch (this.status) {
      case "idle":
        this.become("service");
        break;
      case "service":
        this.become("playing", function() { this.started = this.service = wonByPlayer });
        break;
      case "finished":
        this.become("playing", this.rematch);
        break;
      default:
        this.processScore(wonByPlayer);
